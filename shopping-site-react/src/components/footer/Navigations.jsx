...
export default function Navigations() {
  ...
  const displayCategory = (category) => {
    return category.map((value, index) => (
      <a className="hover:underline hover:cursor-pointer flex flex-row text-nowrap flex-nowrap h-fit">
  ...
  return (
    <div className="shadow bg-gray-100 py-10 text-xs text-gray-500 text-pretty">
      <div className="w-5/6 mx-auto my-0 h-full flex flex-col justify-between items-center ">
        <div className="flex">
          <a className="hover:underline hover:cursor-pointer inline px-3">
